...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Setting Pilot — Pipeline Control" },
      { name: "description", content: "Cabina de mando para gestión de leads" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Setting Pilot — Pipeline Control" },
      { property: "og:description", content: "Cabina de mando para gestión de leads" },
